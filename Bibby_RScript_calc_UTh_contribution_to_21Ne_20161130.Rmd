...
##1st: Specify site abbreviation of interest: 
ie. OV, MC, ML, etc.
```{r}
site_location="OV"
```
...
=======
sample_age = 2e6 #Ma
>>>>>>> e4d94ce1c69cfaf0ebd9491a2278cbc2c6d2c941
...
extended_geochem_data %>% 
  select(sample_id,element,isotope,isoprob,numeric_ppm,iso_ppm) %>%
...
extended_geochem_data %>%
  ...
  ylab("Parent atoms (n)")
```
Looks like the numper of parent atoms matches the intial element concentration. That's good!
