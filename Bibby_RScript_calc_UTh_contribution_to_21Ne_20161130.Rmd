...
No this is just the number of atoms of U and Th in the measured sample.
...
extended_geochem_data %>%
  select(sample_id,numeric_ppm,iso_ppm,isotope,parent_atoms) %>%
  arrange(sample_id) %>% 
  datatable() 
...
##Start Here
Coxx et al, via our correspondence called the above calculation "parent atoms", but I think he's wrong. I think this calcualtion give "current atoms". Since we have current atoms, we need to figure out how many were there in the past, since some have since decayed to another form. We can estimate how much time has passed (t), and if we know the hypothetical decay rate of an isotope, we shold be able to  calculate the number of initial atoms.
